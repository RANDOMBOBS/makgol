    ...
    <div class="all_category">
        ...
        <ul class="main_category">
            <li>
                <c:choose>
                    <c:when test="${loginedUserVo == null}">
                        <a href="http://43.201.110.148 /store/list?x=127.028290548097&y=37.4998293543379&keyword=한식">한식</a>
                    </c:when>
                    <c:otherwise>
                        <a href="http://43.201.110.148 /store/list?x=${loginedUserVo.longitude}&y=${loginedUserVo.latitude}&keyword=한식">한식</a>
                    </c:otherwise>
                </c:choose>
            ...
            <li>
                <c:choose>
                    <c:when test="${loginedUserVo == null}">
                        <a href="http://43.201.110.148 /store/list?x=127.028290548097&y=37.4998293543379&keyword=중식">중식</a>
                    </c:when>
                    <c:otherwise>
                        <a href="http://43.201.110.148 /store/list?x=${loginedUserVo.longitude}&y=${loginedUserVo.latitude}&keyword=중식">중식</a>
                    </c:otherwise>
                </c:choose>
            </li>
            <li>
                <c:choose>
                    <c:when test="${loginedUserVo == null}">
                        <a href="http://43.201.110.148 /store/list?x=127.028290548097&y=37.4998293543379&keyword=일식">일식</a>
                    </c:when>
                    <c:otherwise>
                        <a href="http://43.201.110.148 /store/list?x=${loginedUserVo.longitude}&y=${loginedUserVo.latitude}&keyword=일식">일식</a>
                    </c:otherwise>
                </c:choose>
            </li>
            <li>
                <c:choose>
                    <c:when test="${loginedUserVogit == null}">
                        <a href="http://43.201.110.148 /store/list?x=127.028290548097&y=37.4998293543379&keyword=양식">양식</a>
                    </c:when>
                    <c:otherwise>
                        <a href="http://43.201.110.148 /store/list?x=${loginedUserVo.longitude}&y=${loginedUserVo.latitude}&keyword=양식">양식</a>
                    </c:otherwise>
                </c:choose>
            </li>
            <li>
                <c:choose>
                    <c:when test="${loginedUserVo == null}">
                        <a href="http://43.201.110.148 /store/list?x=127.028290548097&y=37.4998293543379&keyword=분식">분식</a>
                    </c:when>
                    <c:otherwise>
                        <a href="http://43.201.110.148 /store/list?x=${loginedUserVo.longitude}&y=${loginedUserVo.latitude}&keyword=분식">분식</a>
                    </c:otherwise>
                </c:choose>
            </li>
            <li>
                <c:choose>
                    <c:when test="${loginedUserVo == null}">
                        <a href="http://43.201.110.148 /store/list?x=127.028290548097&y=37.4998293543379&keyword=카페">카페</a>
                    </c:when>
                    <c:otherwise>
                        <a href="http://43.201.110.148 /store/list?x=${loginedUserVo.longitude}&y=${loginedUserVo.latitude}&keyword=카페">카페</a>
                    </c:otherwise>
                </c:choose>
            </li>
        </ul>
    </div>
    <a href="http://43.201.110.148 "><img id="logoimage" src="<c:url value='/resources/static/image/default/mainLogo.png' />"></a>
    <div class="userTab">
        <c:choose>
        ...
        <ul class="depth1">
            ...
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <li><a href="#" id="login_modal">로그인123</a></li>
                </c:otherwise>
            </c:choose>
        </ul>
    </div>
